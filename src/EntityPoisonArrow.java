...
public class EntityPoisonArrow extends EntityArrow
{
    ...
    public EntityPoisonArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        xTile = -1;
        yTile = -1;
    ...
    public EntityPoisonArrow(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        xTile = -1;
        yTile = -1;
        ...
        if (movingobjectposition != null)
        {
            if (movingobjectposition.entityHit != null)
            {
                ...
                if (movingobjectposition.entityHit.attackEntityFrom(damagesource, j1))
                {
                    ...
                    {
                    	((EntityLiving)movingobjectposition.entityHit).addPotionEffect(new PotionEffect(Potion.poison.id, 20000, 20000));
                    }
